...
<body>
    <div class="container mt-5">
        ...
        <div class="row">
            <div class="col-md-8">
                <form action="{{ route('comidas.update', $comida->id_comida) }}" method="POST" class="needs-validation">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('nombre_comida') is-invalid @enderror" 
                               id="nombre_comida" name="nombre_comida" value="{{ old('nombre_comida', $comida->nombre_comida) }}" required>
                        @error('nombre_comida')
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" step="0.01" class="form-control @error('costo') is-invalid @enderror" 
                               id="costo" name="costo" value="{{ old('costo', $comida->costo) }}" required>
                        @error('costo')
                            <span class="invalid-feedback">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('detalle_comida') is-invalid @enderror" 
                                  id="detalle_comida" name="detalle_comida" rows="4" required>{{ old('detalle_comida', $comida->detalle_comida) }}</textarea>
